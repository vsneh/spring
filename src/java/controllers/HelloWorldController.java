...
public class HelloWorldController {
    ...
    public String processClientProfile(@ModelAttribute("profileBean") ProfileBean profile,
        ...
        // profile.xxx
        String resultStr = "";
        resultStr += "Hello " + profile.getClientName() + "<br/>";
        resultStr += "I see that you are a " + profile.getGender() + " " + profile.getPosition() + "<br/>";

        String temp = "";
        for (int i = 0; i < profile.getIndustries().length; i++) {
            temp += profile.getIndustries()[i] + "; ";
        }
        ...
        temp = "";
        for (int i = 0; i < profile.getInterests().length; i++) {
            temp += profile.getInterests()[i] + "; ";
        }
